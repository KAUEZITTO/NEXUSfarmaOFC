...
const changelog = [
    { version: '1.2.1', changes: ['Correção de erro crítico que impedia o login e o salvamento de todos os cadastros ao garantir a conexão correta com o banco de dados.'] },
    { version: '1.2.0', changes: ['Mudança de estratégia: Renderização dinâmica forçada em todas as páginas do dashboard para resolver erros de pré-renderização no build.'] },
    { version: '1.1.6', changes: ['Refatoração global de todos os componentes do dashboard para corrigir erros persistentes de pré-renderização (prerender-error).'] },
    { version: '1.1.5', changes: ['Correção global de erros de pré-renderização (prerender-error) no dashboard, garantindo builds estáveis.'] },
