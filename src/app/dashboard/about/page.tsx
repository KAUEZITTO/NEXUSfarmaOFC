...
const changelog = [
    { version: '3.8.5', changes: ['Implementada correção final e definitiva na arquitetura de autenticação para resolver o erro "?error=Configuration", garantindo a máxima estabilidade do login em ambientes serverless.'] },
    ...
    { version: '3.8.2', changes: ['Removido o tour guiado para uma interface mais limpa e direta, otimizando a experiência do usuário experiente.'] },
