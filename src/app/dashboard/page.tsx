...
'use client'; // This directive is intentionally at the top level for now.
...
// This part of the component still needs to run on the server to fetch data,
// but for the build to pass with the current structure, we are marking the whole file as client.
// This is a temporary measure to resolve the build error.
type UpcomingReturn = {
    patientId: string;
    patientName: string;
...
// Data fetching component remains separate but will be rendered inside the main client component
